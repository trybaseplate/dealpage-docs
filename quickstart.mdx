...
---
    ...
    <Tip> Customer favorites are the Slack, Drive, and Salesforce integrations (Only on Team and Business Plans). </Tip>
    ...
    <img src="/images/designed-library.png" alt="Library" />
        ...
        Upload a few docs to your [Knowledge Base](/usage/knowledge-base) in the Content Library tab. If you connected a Drive, Notion, or Confluence integration you can
