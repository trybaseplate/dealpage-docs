...
Upload any files you'd like to be sources to your [Knowledge Base](/usage/knowledge-base).
...
### Integrations
See [Integrations](../usage/integrations) for up-to-date info on our supported integrations.
