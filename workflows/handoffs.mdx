...
<img src="/images/chat-handoffs.png" alt="conduct handoffs asynchronously via AI Chat" />

## Examples
1. Summarize the deal with Acme Corp. Did we discuss budget?
2. Search our deal with Yodo with opportunities for upsell and account growth, then search for potential churn risks we identified. Then generate a handoff report for account managers 
...
<img src="/images/handoffs-template.png" alt="template for document-based account handoffs" />
...
<img src="/images/handoffs-filled.png" alt="a Template filled out with Deal Info for a handoff" />
